...
putc(int fd, char c)
{
 ...
 578:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 57b:	b8 a6 07 00 00       	mov    $0x7a6,%eax
...
malloc(uint nbytes)
{
 ...
 73c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 73f:	89 15 60 0a 00 00    	mov    %edx,0xa60
      return (void*)(p + 1);
 ...
 754:	eb e9                	jmp    73f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 60 0a 00 00 64 	movl   $0xa64,0xa60
 75d:	0a 00 00 
 760:	c7 05 64 0a 00 00 64 	movl   $0xa64,0xa64
 767:	0a 00 00 
    base.s.size = 0;
 76a:	b8 64 0a 00 00       	mov    $0xa64,%eax
 76f:	c7 05 68 0a 00 00 00 	movl   $0x0,0xa68
 776:	00 00 00 
